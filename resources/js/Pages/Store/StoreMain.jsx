    ...
    <div>
      <StoreLayout>
        <div className="w-full  pt-[30px] pb-[60px]">
          ...
          <div
            data-aos="fade-up"
            className="section-style-one category-products mb-[60px] aos-init"
          >
                    ...
                    <div className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5">
                      <div className="category-card hidden xl:block w-full">
                        <div
                          ...
                          style={{
                            background:
                              'url("/assets/images/section-category-1.jpg") 0% 0% / cover no-repeat',
                          }}
                        >
                          <div>
                      ...
                      <div className="item">
                        ...
                        >
                          ...
                          <div className="product-card-details px-[30px] pb-[30px] relative">
                            ...
                            <a href="/single-product">
                              <p className="title mb-2 text-[15px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600">
                                Conjurica ea magna eiusmod esse cupt anim
                                aliquip
                              </p>
                            </a>
                            <p className="price">
          ...
          <div
            data-aos="fade-up"
            className="w-full brand-section-wrapper mb-[60px] aos-init"
          >
            <div className="container-x mx-auto">
              <div className=" section-title flex justify-between items-center mb-5">
                <div>
              ...
              <div className="container-x mx-auto h-full">
                <div className="lg:flex xl:space-x-[30px] lg:space-x-5 items-center h-full">
                  <div
                    ...
                    style={{
                      background:
                        'url("/assets/images/campaign-cover-countdown.jpg") 0% 0% / cover no-repeat',
                    }}
                  >
                    <a href="/flash-sale">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        'url("/assets/images/download-app-cover.png") 0% 0% / cover no-repeat',
                    }}
                  >
                    <div className="flex flex-col h-full justify-between">
                      ...
                      <div className="app-screen">
                        <img src="/assets/images/app-screen.png" alt="" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="section-content">
                <div className="section-content w-full grid sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5 ">
                  <div className="item w-full">
                    <div
                      data-aos="fade-left"
                      className="product-row-card-style-one w-full h-[250px] bg-white group relative overflow-hidden aos-init"
                    >
                          ...
                          <div>
                            ...
                            <a href="/single-product">
                              <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600">
                                Senmei ipsum dolore eiusmod dolor officia do
                                nisi
                              </p>
                            </a>
                      ...
                      <div className="flex space-x-5 items-center w-full h-full lg:p-[30px] sm:p-5 p-2">
                        ...
                        <div className="flex-1 flex flex-col justify-center h-full">
                          <div>
                            ...
                            <a href="/single-product">
                              <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600">
                                Canopoly duis voluptate dolor sunt sit
                                adipisicing in
                              </p>
                            </a>
                            <p className="price mb-[26px]">
                    ...
                    <div className="grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 xl:gap-[30px] gap-5">
                      <div className="category-card hidden xl:block w-full">
                        <div
                          ...
                          style={{
                            background:
                              'url("/assets/images/section-category-2.jpg") 0% 0% / cover no-repeat',
                          }}
                        >
                          <div>
                            <h1 className="text-base font-600 tracking-wide mb-2">
                      ...
                      <div data-aos="fade-up" className="item aos-init">
                        ...
                        >
                          ...
                          <div className="product-card-details px-[30px] pb-[30px] relative">
                            ...
                            <a href="/single-product">
                              <p className="title mb-2 text-[15px] font-600 text-qblack leading-[24px] line-clamp-2 hover:text-blue-600">
                                Empirica deserunt laborum ad quis labore labore
                                eu
                              </p>
                            </a>
                            <p className="price">
                  ...
                  <div className="products-section w-full">
                    <div className="grid lg:grid-cols-3 grid-cols-1 xl:gap-[30px] lg:gap-5">
                      <div className="item-col">
                        <div
                          data-aos="fade-up"
                          className="product-card-row-two w-full aos-init"
                        >
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Xoggle aute et pariatur adipisicing nostrud
                                    et excepteur
                                  </p>
                                </a>
                                <p className="price">
                          ...
                          <div className="w-full h-[105px] bg-white border border-primarygray px-5 ">
                            <div className="w-full h-full flex space-x-5 justify-center items-center">
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Unisure aliqua repreh ex cupt qui elit
                                    officia
                                  </p>
                                </a>
                                <p className="price">
                          ...
                          <div className="w-full h-[105px] bg-white border border-primarygray px-5 ">
                            <div className="w-full h-full flex space-x-5 justify-center items-center">
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Kenegy consectetur id ex nulla in
                          ...
                          <div className="w-full h-[105px] bg-white border border-primarygray px-5 ">
                            <div className="w-full h-full flex space-x-5 justify-center items-center">
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Bizmatic consequat enim quis sit et est
                                    eiusmod
                                  </p>
                                </a>
                                <p className="price">
                          ...
                          <div className="w-full h-[105px] bg-white border border-primarygray px-5 ">
                            <div className="w-full h-full flex space-x-5 justify-center items-center">
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Anarco consectetur magna nostrud commodo
                          ...
                          <div className="w-full h-[105px] bg-white border border-primarygray px-5 ">
                            <div className="w-full h-full flex space-x-5 justify-center items-center">
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Plasto cillum ad minim elit fugiat esse
                                    dolore
                                  </p>
                                </a>
                                <p className="price">
                          ...
                          <div className="w-full h-[105px] bg-white border border-primarygray px-5 ">
                            <div className="w-full h-full flex space-x-5 justify-center items-center">
                              ...
                              <div className="flex-1 h-full flex flex-col justify-center ">
                                <a href="/single-product">
                                  <p className="title mb-2 sm:text-[15px] text-[13px] font-600 text-qblack leading-[24px] line-clamp-1 hover:text-blue-600">
                                    Empirica deserunt laborum ad quis labore
                                    labore eu
                                  </p>
                                </a>
                                <p className="price">
        ...
        <div
          ...
          style={{
            background:
              'url("/assets/images/discount-banner-1.jpg") 0% 0% / cover no-repeat',
          }}
        >
          <div>
            ...
            <div
              data-aos="fade-right"
              className="sm:w-[543px] w-[300px] h-[54px] flex mt-8 aos-init"
            >
