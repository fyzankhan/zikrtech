...
const Sidebar = () => {
  ...
  return (
    <div className="block lg:block lg:w-64 bg-white shadow-lg lg:relative absolute z-20">
      <aside
        id="sidebar-multi-level-sidebar"
        className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0"
        aria-label="Sidebar"
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <svg
                  className={`w-3 h-3 transform ${
                    dropdowns["dropdown1"] ? "rotate-180" : ""
                  }`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <ul
                id="dropdown-example"
                className={`${
                  dropdowns["dropdown1"] ? "block" : "hidden"
                } py-2 space-y-2`}
              >
                <li>
                  <NavLink
            ...
            <li>
              ...
              >
                ...
                <svg
                  className={`w-3 h-3 transform ${
                    dropdowns["dropdown2"] ? "rotate-180" : ""
                  }`}
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
              ...
              <ul
                id="dropdown-example"
                className={`${
                  dropdowns["dropdown2"] ? "block" : "hidden"
                } py-2 space-y-2`}
              >
                <li>
                  <a
