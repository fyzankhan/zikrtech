              ...
              <div className="grid xl:grid-cols-6 lg:grid-cols-5 sm:grid-cols-3 grid-cols-1 xl:gap-[30px] gap-5">
                ...
                >
                  <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                    <img src="/assets/images/storage1.png" alt="" />
                  </div>
                  <a href="/data-media">
                    <p className="text-base font-500 text-center">Data Media</p>
                  </a>
                </div>
                <div
                  data-aos="fade-left"
                ...
                >
                  <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                    <img src="/assets/images/routers.png" alt="" />
                  </div>
                  <a href="/saller-page">
                    <p className="text-base font-500 text-center">Routers</p>
                  </a>
                </div>
                <div
                  data-aos="fade-left"
                ...
                >
                  ...
                  <a href="/saller-page">
                    <p className="text-base font-500 text-center">Servers</p>
                  </a>
                </div>
                <div
                  data-aos="fade-left"
                ...
                >
                  ...
                  <a href="/saller-page">
                    <p className="text-base font-500 text-center">Switches</p>
                  </a>
                </div>
                <div
                  data-aos="fade-left"
                ...
                >
                  <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                    <img src="/assets/images/monitors.webp" alt="" />
                  </div>
                  <a href="/saller-page">
                    <p className="text-base font-500 text-center">Monitors</p>
                  </a>
                </div>
                <div
                  data-aos="fade-left"
                ...
                >
                  <div className="w-[170px] h-[170px] rounded-full bg-white flex justify-center items-center overflow-hidden mb-2">
                    <img src="/assets/images/notebook.webp" alt="" />
                  </div>
                  <a href="/saller-page">
                    <p className="text-base font-500 text-center">Notebooks</p>
                  </a>
                </div>
              </div>
            </div>
