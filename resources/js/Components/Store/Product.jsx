...
const Product = ({ product, isOfferActive }) => {
  return (
    <>
      <div
      ...
      >
        ...
        <div className="product-card-details px-[30px] pb-[30px] relative">
          <div className="absolute w-full h-10 px-[30px] left-0 top-40 group-hover:top-[55px] transition-all duration-300 ease-in-out">
            <AddToCartButton
          ...
          <p className="price">
            <span
              className={`main-price ${
                isOfferActive ? "text-qgray line-through" : "text-qred"
              } font-600 text-[18px]`}
            >
              ${product.price}
            </span>
